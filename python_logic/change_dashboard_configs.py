...
if __name__ == '__main__':
    # python3 sfsnowsightextensions/python_logic/change_dashboard_configs.py -f $work_dir/filters -r ACCOUNTADMIN -w COMPUTE_WH -d dashboard_db -s dashboard_schema -a myacctlocator
